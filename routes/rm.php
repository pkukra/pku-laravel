...
Route::prefix('rm')->middleware(['auth'])->group(function () {
    ...
    Route::get('/pasien-rujukan/get_all_obat/{kode_reg}', [PasienRujukanController::class, 'get_all_obat'])->name('rm.pasien-rujukan.get_all_obat');
    ...
    Route::get('/pasien-rujukan/get_laporan_ok/{nomer_rm}', [PasienRujukanController::class, 'get_laporan_ok'])->name('rm.pasien-rujukan.get_laporan_ok');
});
...
Route::prefix('rm')->middleware(['auth', CheckRole::class . ':superadmin,koder,klaim,dokter'])->group(function () {
    ...
    Route::prefix('pasien-inap')->group(function () {
        ...
        Route::post('/grouping_idrg_stage_dua/{no_sep}', [PasienInapController::class, 'grouping_idrg_stage_dua'])->name('rm.pasien-inap.grouping_idrg_stage_dua'); // baru topup idrg
