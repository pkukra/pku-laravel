...
export default function Index({ auth }) {
    ...
    const handleSearch = async (kode = kodeFilter) => {
        ...
        try {
            ...
            const res = await axios.get(
                route("rm_report.ranap_by_code_data"),
                {
                    params: {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<p>Laporan Per Penyakit Show Group Ranap</p>}
        >
            <Head title="Laporan Per Penyakit Show Group Ranap" />

            <Card title="Laporan Per Penyakit Show Group Ranap">
