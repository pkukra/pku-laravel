...
export default function ModalDelete({ id, s }) {
    const {
        ...
        pasien_rujukan_id: s.pasien_rujukan_id,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        Inertia.post(`/deletePasienRujukan/${deleteData.pasien_rujukan_id}`, {
            _method: "delete",
            ...deleteData,
        });
    };
    ...
    return (
        <>
            <button
                onClick={() => {
                    return document
                        .getElementById(`my_modal_4${s.pasien_rujukan_id}`)
                        .showModal();
                }}
                    ...
                    <div className="modal-body">
                        <h3 className="font-bold text-lg">
                            ...
                            <small className="block">
                                id: {deleteData.pasien_rujukan_id}
                            </small>
                        </h3>
                        <form
