                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <span>
                                Total PasienRujukans:{" "}
                                {count == 0 ? "No pasien_rujukans yet" : count}
                            </span>
                        </div>
                        <table className="table">
                            ...
                            <tbody>
                                {pasien_rujukans.map((s) => {
                                    return (
                                        <tr
                                            className="text-black hover:bg-slate-300"
                                            key={s.pasien_rujukan_id}
                                        >
                                            <td>{s.pasien_rujukan_id}</td>
                                            <td>
                                            ...
                                            <th className="flex gap-3">
                                                {/* Modal */}
                                                <ModalUpdate
                                                    id={`my_modal_3${s.pasien_rujukan_id}`}
                                                    s={s}
                                                />
                                                <ModalDelete
                                                    id={`my_modal_4${s.pasien_rujukan_id}`}
                                                    s={s}
                                                />
                                            </th>
                                        </tr>
